//go:generate protoc --proto_path=. --go_out=. --go_opt=paths=source_relative weather.proto
...
const file_weather_proto_rawDesc = "" +
	...
	"\n" +
	"GetWeather\x12\x12.GetWeatherRequest\x1a\b.Weather\"\x00B/Z-github.com/maljanahi99/protos/weather_trackerb\x06proto3"
